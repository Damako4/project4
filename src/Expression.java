package src;//import javafx.scene.layout.*;
...
interface Expression {
         ...
         * the copied src.Expression is as deep as possible.
	...
	/**
	 * Produce a new, fully independent (i.e., there should be no shared subtrees) src.Expression
