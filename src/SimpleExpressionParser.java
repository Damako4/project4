...
public class SimpleExpressionParser implements ExpressionParser {
         ...
         * Throws a src.ExpressionParseException if the specified string cannot be parsed.
	 * Grammar:
	 * S -> A | P
	 * A -> A+M | A-M | M
	 * M -> M*E | M/E | E
	 ...
	 * V -> x
         ...
         * @return the src.Expression object representing the parsed expression tree
         */
